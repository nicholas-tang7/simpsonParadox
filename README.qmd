...
- **Left plot:** Shows the misleading overall positive relationship (red line going up)
- **Right plot:** Reveals the truth - within each species, the relationship is actually negative (colored lines going down)

The contrast is striking and immediately shows why we must always consider confounding variables and group-specific relationships before drawing conclusions from aggregate data.
